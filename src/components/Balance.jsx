...
export default function Balance() {
    ...
    return (
        <div className="inline-flex flex-row h-20 w-full justify-between">
            <h2 className="w-fit ml-3 text-4xl font-mono bg-gradient-to-r bg-clip-text  text-transparent  from-metal via-[#c6b3d8] to-metal animate-text" data-cy="account-balance">Hi Dev!<br />${balance}</h2>
