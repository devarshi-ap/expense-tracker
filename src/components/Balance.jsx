...
export default function Balance() {
    ...
    return (
        <div className="inline-flex flex-row h-20 w-full justify-between">
            ...
            <img src="https://i.imgur.com/LS0NftU.gif" className="h-20 w-auto mr-7 top-4 relative rounded-lg hover:cursor-pointer" alt="Psyduck" title="Click to Reset" onClick={() => window.location.reload(false)}/>
        </div>
    )
}